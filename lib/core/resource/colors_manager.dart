...
const Color gray           =       Color(0xFF999999);            // رمادي
const Color freshGreen     =       Color(0xFF9DC284);      // أخضر فاتح 3
const Color grayDark       =       Color(0xFF969494);        // رمادي غامق
const Color mintGreen1     =       Color(0xFFBDDFBF);      // أخضر نعناعي 1
const Color mintGreen2     =       Color(0xFFB5DDC0);      // أخضر نعناعي 2
const Color mintGreen3     =       Color(0xFFC9EDD7);      // أخضر نعناعي 3
const Color veryLightGreen1 =       Color(0xFFCCE2D4);  // أخضر فاتح جداً
const Color lightRed        =       Color(0xFFECAEAE);       // احمر فاتح
