...
class _SignInPageState extends State<SignInPage> {
  final TextEditingController _myCodeController = TextEditingController();
  final TextEditingController _mosqueCodeController = TextEditingController();
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: Icon(icon, color: greenLight),
