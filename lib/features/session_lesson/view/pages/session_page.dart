...
class SessionPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          SessionBloc(sl(), sl())..add(FetchSessionEvent(circleId: circleId)),
      child: Scaffold(
              ...
              child: Container(
                ...
                child: BlocBuilder<SessionBloc, SessionState>(
                  builder: (context, state) {
                    ...
                    } else if (state.fetchSessionStatus ==
            ...
            actions: [
              ...
              BlocConsumer<SessionBloc, SessionState>(
                listener: (context, state) {
                  ...
                  } else if (state.createSessionStatus ==
                      ControllerStatus.error) {
                ...
                builder: (context, state) {
                  return TextButton(
                    onPressed:
                        state.createSessionStatus == ControllerStatus.loading
                            ? null
                            : () {
