...
class GetRemotRecord {
  ...
  Future<Either<ErrorModel,List<RecordModel>>> get_remot_record() async {
   final result= await ApiService.instance.makeRequest(method: ApiMethod.get, endPoint: ApiManager.GetaudiApi);
     return result.fold((l){
return Left(ErrorModel(message: l.toString()));

     },(r){
      List<RecordModel> list=List.generate(r["Audios"].length,(index)=>RecordModel.fromMap(r["Audios"][index]));
